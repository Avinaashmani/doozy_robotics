...
#define NODE_MAIN_LOGGER_NAME "apriltag_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libAprilTagNode.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<AprilTagNode>";
