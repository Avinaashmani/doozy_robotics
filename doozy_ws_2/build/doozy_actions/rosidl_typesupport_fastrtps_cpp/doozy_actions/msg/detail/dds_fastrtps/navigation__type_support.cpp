...
#include "doozy_actions/msg/detail/navigation__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const doozy_actions::msg::Navigation & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: moved_to_spot
  cdr << (ros_message.moved_to_spot ? true : false);
  // Member: idx_of_dolly
  cdr << ros_message.idx_of_dolly;
  // Member: error
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  doozy_actions::msg::Navigation & ros_message)
{
  // Member: moved_to_spot
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const doozy_actions::msg::Navigation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<doozy_actions::msg::Navigation *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Navigation(full_bounded, 0);
}
...
{
  return &doozy_actions::msg::typesupport_fastrtps_cpp::_Navigation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, doozy_actions, msg, Navigation)() {
  return &doozy_actions::msg::typesupport_fastrtps_cpp::_Navigation__handle;
}
