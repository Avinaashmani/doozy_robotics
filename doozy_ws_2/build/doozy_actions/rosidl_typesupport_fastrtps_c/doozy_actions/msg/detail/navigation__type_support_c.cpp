...
#include "doozy_actions/msg/detail/navigation__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // error, idx_of_dolly
#include "rosidl_runtime_c/string_functions.h"  // error, idx_of_dolly

// forward declare type support functions


using _Navigation__ros_msg_type = doozy_actions__msg__Navigation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: moved_to_spot
  {
    cdr << (ros_message->moved_to_spot ? true : false);
  }

  // Field name: idx_of_dolly
  {
    const rosidl_runtime_c__String * str = &ros_message->idx_of_dolly;
  ...
  void * untyped_ros_message)
{
  ...
  _Navigation__ros_msg_type * ros_message = static_cast<_Navigation__ros_msg_type *>(untyped_ros_message);
  // Field name: moved_to_spot
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->moved_to_spot = tmp ? true : false;
  }
  ...
  // Field name: idx_of_dolly
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->idx_of_dolly.data) {
      rosidl_runtime_c__String__init(&ros_message->idx_of_dolly);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->idx_of_dolly,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'idx_of_dolly'\n");
      return false;
    }
  }
...
size_t get_serialized_size_doozy_actions__msg__Navigation(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name moved_to_spot
  {
    size_t item_size = sizeof(ros_message->moved_to_spot);
  ...
  current_alignment += padding +
    ...
    (ros_message->idx_of_dolly.size + 1);
  // field.name error
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
...
static uint32_t _Navigation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_doozy_actions__msg__Navigation(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, doozy_actions, msg, Navigation)() {
