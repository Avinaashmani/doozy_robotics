...
{
  irobot_create_msgs__msg__LedColor * msg = (irobot_create_msgs__msg__LedColor *)malloc(sizeof(irobot_create_msgs__msg__LedColor));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__LedColor__Sequence__init(irobot_create_msgs__msg__LedColor__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__LedColor *)calloc(size, sizeof(irobot_create_msgs__msg__LedColor));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__LedColor__Sequence * array = (irobot_create_msgs__msg__LedColor__Sequence *)malloc(sizeof(irobot_create_msgs__msg__LedColor__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__LedColor__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__LedColor * data =
      (irobot_create_msgs__msg__LedColor *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__LedColor__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__LedColor__fini(&data[i]);
        }
        free(data);
        return false;
      }
