...
{
  irobot_create_msgs__msg__IrIntensityVector * msg = (irobot_create_msgs__msg__IrIntensityVector *)malloc(sizeof(irobot_create_msgs__msg__IrIntensityVector));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__IrIntensityVector__Sequence__init(irobot_create_msgs__msg__IrIntensityVector__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__IrIntensityVector *)calloc(size, sizeof(irobot_create_msgs__msg__IrIntensityVector));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__IrIntensityVector__Sequence * array = (irobot_create_msgs__msg__IrIntensityVector__Sequence *)malloc(sizeof(irobot_create_msgs__msg__IrIntensityVector__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__IrIntensityVector__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__IrIntensityVector * data =
      (irobot_create_msgs__msg__IrIntensityVector *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__IrIntensityVector__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__IrIntensityVector__fini(&data[i]);
        }
        free(data);
        return false;
      }
