...
{
  irobot_create_msgs__msg__WheelVels * msg = (irobot_create_msgs__msg__WheelVels *)malloc(sizeof(irobot_create_msgs__msg__WheelVels));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__WheelVels__Sequence__init(irobot_create_msgs__msg__WheelVels__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__WheelVels *)calloc(size, sizeof(irobot_create_msgs__msg__WheelVels));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__WheelVels__Sequence * array = (irobot_create_msgs__msg__WheelVels__Sequence *)malloc(sizeof(irobot_create_msgs__msg__WheelVels__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__WheelVels__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__WheelVels * data =
      (irobot_create_msgs__msg__WheelVels *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__WheelVels__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__WheelVels__fini(&data[i]);
        }
        free(data);
        return false;
      }
