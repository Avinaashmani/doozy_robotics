...
{
  irobot_create_msgs__msg__StopStatus * msg = (irobot_create_msgs__msg__StopStatus *)malloc(sizeof(irobot_create_msgs__msg__StopStatus));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__StopStatus__Sequence__init(irobot_create_msgs__msg__StopStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__StopStatus *)calloc(size, sizeof(irobot_create_msgs__msg__StopStatus));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__StopStatus__Sequence * array = (irobot_create_msgs__msg__StopStatus__Sequence *)malloc(sizeof(irobot_create_msgs__msg__StopStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__StopStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__StopStatus * data =
      (irobot_create_msgs__msg__StopStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__StopStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__StopStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
