...
{
  irobot_create_msgs__msg__SlipStatus * msg = (irobot_create_msgs__msg__SlipStatus *)malloc(sizeof(irobot_create_msgs__msg__SlipStatus));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__SlipStatus__Sequence__init(irobot_create_msgs__msg__SlipStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__SlipStatus *)calloc(size, sizeof(irobot_create_msgs__msg__SlipStatus));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__SlipStatus__Sequence * array = (irobot_create_msgs__msg__SlipStatus__Sequence *)malloc(sizeof(irobot_create_msgs__msg__SlipStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__SlipStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__SlipStatus * data =
      (irobot_create_msgs__msg__SlipStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__SlipStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__SlipStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
