...
static const _RobotPower_Request_type_support_symbol_names_t _RobotPower_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irobot_create_msgs, srv, RobotPower_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, irobot_create_msgs, srv, RobotPower_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, irobot_create_msgs, srv, RobotPower_Request)() {
  return &::irobot_create_msgs::srv::rosidl_typesupport_c::RobotPower_Request_message_type_support_handle;
}
...
static const _RobotPower_Response_type_support_symbol_names_t _RobotPower_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irobot_create_msgs, srv, RobotPower_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, irobot_create_msgs, srv, RobotPower_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_irobot_create_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, irobot_create_msgs, srv, RobotPower_Response)() {
  return &::irobot_create_msgs::srv::rosidl_typesupport_c::RobotPower_Response_message_type_support_handle;
}
...
static const _RobotPower_type_support_symbol_names_t _RobotPower_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irobot_create_msgs, srv, RobotPower)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, irobot_create_msgs, srv, RobotPower)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, irobot_create_msgs, srv, RobotPower)() {
  return &::irobot_create_msgs::srv::rosidl_typesupport_c::RobotPower_service_type_support_handle;
}
