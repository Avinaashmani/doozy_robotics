...
static size_t _WallFollow_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_Goal(
    full_bounded, 0);
}
...
static size_t _WallFollow_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_Result(
    full_bounded, 0);
}
...
static size_t _WallFollow_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_Feedback(
    full_bounded, 0);
}
...
static size_t _WallFollow_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _WallFollow_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _WallFollow_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_GetResult_Request(
    full_bounded, 0);
}
...
static size_t _WallFollow_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_GetResult_Response(
    full_bounded, 0);
}
...
static size_t _WallFollow_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__WallFollow_FeedbackMessage(
    full_bounded, 0);
}
