...
static size_t _DriveArc_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_Goal(
    full_bounded, 0);
}
...
static size_t _DriveArc_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_Result(
    full_bounded, 0);
}
...
static size_t _DriveArc_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_Feedback(
    full_bounded, 0);
}
...
static size_t _DriveArc_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _DriveArc_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _DriveArc_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_GetResult_Request(
    full_bounded, 0);
}
...
static size_t _DriveArc_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_GetResult_Response(
    full_bounded, 0);
}
...
static size_t _DriveArc_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__DriveArc_FeedbackMessage(
    full_bounded, 0);
}
