...
static size_t _RotateAngle_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_Goal(
    full_bounded, 0);
}
...
static size_t _RotateAngle_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_Result(
    full_bounded, 0);
}
...
static size_t _RotateAngle_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_Feedback(
    full_bounded, 0);
}
...
static size_t _RotateAngle_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _RotateAngle_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _RotateAngle_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_GetResult_Request(
    full_bounded, 0);
}
...
static size_t _RotateAngle_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_GetResult_Response(
    full_bounded, 0);
}
...
static size_t _RotateAngle_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_irobot_create_msgs__action__RotateAngle_FeedbackMessage(
    full_bounded, 0);
}
