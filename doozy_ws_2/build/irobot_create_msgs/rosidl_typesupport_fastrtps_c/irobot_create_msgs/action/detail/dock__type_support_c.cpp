...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_irobot_create_msgs__action__Dock_FeedbackMessage(
    full_bounded, 0);
}
