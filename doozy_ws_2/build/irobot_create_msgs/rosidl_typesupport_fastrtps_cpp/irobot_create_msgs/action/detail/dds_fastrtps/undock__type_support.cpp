...
{
  return max_serialized_size_Undock_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_Undock_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_Undock_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_Undock_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_Undock_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_Undock_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_Undock_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_Undock_FeedbackMessage(full_bounded, 0);
}
