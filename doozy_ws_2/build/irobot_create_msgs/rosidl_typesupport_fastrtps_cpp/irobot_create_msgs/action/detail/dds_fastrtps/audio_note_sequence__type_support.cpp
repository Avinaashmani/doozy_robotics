...
{
  return max_serialized_size_AudioNoteSequence_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_AudioNoteSequence_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_AudioNoteSequence_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_AudioNoteSequence_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_AudioNoteSequence_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_AudioNoteSequence_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_AudioNoteSequence_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_AudioNoteSequence_FeedbackMessage(full_bounded, 0);
}
