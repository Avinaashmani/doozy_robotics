...
{
  return max_serialized_size_RotateAngle_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_RotateAngle_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_RotateAngle_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_RotateAngle_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_RotateAngle_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_RotateAngle_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_RotateAngle_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_RotateAngle_FeedbackMessage(full_bounded, 0);
}
