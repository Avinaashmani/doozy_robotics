...
{
  return max_serialized_size_DriveArc_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_DriveArc_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_DriveArc_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_DriveArc_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_DriveArc_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_DriveArc_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_DriveArc_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_DriveArc_FeedbackMessage(full_bounded, 0);
}
