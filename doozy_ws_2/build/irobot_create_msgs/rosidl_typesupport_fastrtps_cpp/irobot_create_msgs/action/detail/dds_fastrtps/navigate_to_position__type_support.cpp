...
{
  return max_serialized_size_NavigateToPosition_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_NavigateToPosition_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_NavigateToPosition_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_NavigateToPosition_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_NavigateToPosition_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_NavigateToPosition_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_NavigateToPosition_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_NavigateToPosition_FeedbackMessage(full_bounded, 0);
}
