...
{
  irobot_create_msgs__msg__Mouse * msg = (irobot_create_msgs__msg__Mouse *)malloc(sizeof(irobot_create_msgs__msg__Mouse));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__Mouse__Sequence__init(irobot_create_msgs__msg__Mouse__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__Mouse *)calloc(size, sizeof(irobot_create_msgs__msg__Mouse));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__Mouse__Sequence * array = (irobot_create_msgs__msg__Mouse__Sequence *)malloc(sizeof(irobot_create_msgs__msg__Mouse__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__Mouse__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__Mouse * data =
      (irobot_create_msgs__msg__Mouse *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__Mouse__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__Mouse__fini(&data[i]);
        }
        free(data);
        return false;
      }
