...
{
  irobot_create_msgs__msg__WheelTicks * msg = (irobot_create_msgs__msg__WheelTicks *)malloc(sizeof(irobot_create_msgs__msg__WheelTicks));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__WheelTicks__Sequence__init(irobot_create_msgs__msg__WheelTicks__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__WheelTicks *)calloc(size, sizeof(irobot_create_msgs__msg__WheelTicks));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__WheelTicks__Sequence * array = (irobot_create_msgs__msg__WheelTicks__Sequence *)malloc(sizeof(irobot_create_msgs__msg__WheelTicks__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__WheelTicks__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__WheelTicks * data =
      (irobot_create_msgs__msg__WheelTicks *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__WheelTicks__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__WheelTicks__fini(&data[i]);
        }
        free(data);
        return false;
      }
