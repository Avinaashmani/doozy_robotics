...
{
  irobot_create_msgs__msg__WheelStatus * msg = (irobot_create_msgs__msg__WheelStatus *)malloc(sizeof(irobot_create_msgs__msg__WheelStatus));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__WheelStatus__Sequence__init(irobot_create_msgs__msg__WheelStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__WheelStatus *)calloc(size, sizeof(irobot_create_msgs__msg__WheelStatus));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__WheelStatus__Sequence * array = (irobot_create_msgs__msg__WheelStatus__Sequence *)malloc(sizeof(irobot_create_msgs__msg__WheelStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__WheelStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__WheelStatus * data =
      (irobot_create_msgs__msg__WheelStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__WheelStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__WheelStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
