...
{
  irobot_create_msgs__msg__AudioNoteVector * msg = (irobot_create_msgs__msg__AudioNoteVector *)malloc(sizeof(irobot_create_msgs__msg__AudioNoteVector));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__AudioNoteVector__Sequence__init(irobot_create_msgs__msg__AudioNoteVector__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__AudioNoteVector *)calloc(size, sizeof(irobot_create_msgs__msg__AudioNoteVector));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__AudioNoteVector__Sequence * array = (irobot_create_msgs__msg__AudioNoteVector__Sequence *)malloc(sizeof(irobot_create_msgs__msg__AudioNoteVector__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__AudioNoteVector__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__AudioNoteVector * data =
      (irobot_create_msgs__msg__AudioNoteVector *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__AudioNoteVector__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__AudioNoteVector__fini(&data[i]);
        }
        free(data);
        return false;
      }
