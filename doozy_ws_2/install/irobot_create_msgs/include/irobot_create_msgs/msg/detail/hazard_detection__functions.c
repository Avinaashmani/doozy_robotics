...
{
  irobot_create_msgs__msg__HazardDetection * msg = (irobot_create_msgs__msg__HazardDetection *)malloc(sizeof(irobot_create_msgs__msg__HazardDetection));
  if (!msg) {
    return NULL;
  }
...
irobot_create_msgs__msg__HazardDetection__Sequence__init(irobot_create_msgs__msg__HazardDetection__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (irobot_create_msgs__msg__HazardDetection *)calloc(size, sizeof(irobot_create_msgs__msg__HazardDetection));
    if (!data) {
      return false;
    }
...
{
  irobot_create_msgs__msg__HazardDetection__Sequence * array = (irobot_create_msgs__msg__HazardDetection__Sequence *)malloc(sizeof(irobot_create_msgs__msg__HazardDetection__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  irobot_create_msgs__msg__HazardDetection__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    irobot_create_msgs__msg__HazardDetection * data =
      (irobot_create_msgs__msg__HazardDetection *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!irobot_create_msgs__msg__HazardDetection__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          irobot_create_msgs__msg__HazardDetection__fini(&data[i]);
        }
        free(data);
        return false;
      }
