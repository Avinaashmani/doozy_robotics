...
void sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_init_function(
...
void sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_message_members = {
  ...
  sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_message_type_support_handle = {
  0,
  &sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sick_visionary_t_mini, msg, SickTMini)() {
  sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_message_member_array[2].members_ =
  ...
  return &sick_visionary_t_mini__msg__SickTMini__rosidl_typesupport_introspection_c__SickTMini_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
