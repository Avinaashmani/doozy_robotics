...
{
  turtlebot4_msgs__msg__UserDisplay * msg = (turtlebot4_msgs__msg__UserDisplay *)malloc(sizeof(turtlebot4_msgs__msg__UserDisplay));
  if (!msg) {
    return NULL;
  }
...
turtlebot4_msgs__msg__UserDisplay__Sequence__init(turtlebot4_msgs__msg__UserDisplay__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (turtlebot4_msgs__msg__UserDisplay *)calloc(size, sizeof(turtlebot4_msgs__msg__UserDisplay));
    if (!data) {
      return false;
    }
...
{
  turtlebot4_msgs__msg__UserDisplay__Sequence * array = (turtlebot4_msgs__msg__UserDisplay__Sequence *)malloc(sizeof(turtlebot4_msgs__msg__UserDisplay__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  turtlebot4_msgs__msg__UserDisplay__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    turtlebot4_msgs__msg__UserDisplay * data =
      (turtlebot4_msgs__msg__UserDisplay *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!turtlebot4_msgs__msg__UserDisplay__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          turtlebot4_msgs__msg__UserDisplay__fini(&data[i]);
        }
        free(data);
        return false;
      }
