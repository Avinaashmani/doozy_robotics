...
class ROS_GUI(QWidget):
    def __init__(self):
        ...
        # self.node.create_subscription(String, 'display_topic', self.display_callback, 10)
        self.publishers = {
    ...
    def init_ui(self):
        ...
        # self.display_label.setText(self.diagnostic_msg)
    ...
    def display_callback(self, msg):
        self.display_label.setText(str(msg.data))
        print(msg.data)
