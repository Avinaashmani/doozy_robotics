...
class DockDolly(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(Bool, 'dock_topic', self.gui_callback, 10)
        self.create_subscription(Navigation, 'dolly_navigate_node', self.navigate_node_callback, 10)
    ...
    def navigate_node_callback(self, msg):
        self.dolly_frame = msg.idx_of_dolly
        self.get_logger().info(self.dolly_frame)
