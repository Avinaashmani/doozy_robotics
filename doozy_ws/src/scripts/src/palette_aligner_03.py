...
class UltrasonicForkAlignment:
    ...
    def check_sensors(self):
        ...
        if self.value_01 < 40 and self.value_01 > 30:
            ...
            rospy.logwarn_once ("Right Sonar is Mis-aligned...")
            self.range_01 = False
        ...
        if self.value_02 > 30 and self.value_02 < 40:
            ...
            self.range_02 = False
            rospy.logwarn_once ("Center Sonar is Mis-aligned...")
        ...
        if self.value_03 < 50 and self.value_03 > 30:
            ...
            rospy.logwarn_once ("Left Sonar is not Misaligned...")
            self.range_03 = False
    ...
    def compute(self):
        ...
        if self.timer_check() is True:
            ...
            rospy.loginfo_once ("Fork is Aligned....")

        else:
            is_docked = False
            move_forks.linear.x = 0.0
            rospy.logwarn_once ("Fork is Misaligned....")
...
if __name__=='__main__':
    ...
    try:
        ...
        rospy.logwarn_once("Sensor Error...")