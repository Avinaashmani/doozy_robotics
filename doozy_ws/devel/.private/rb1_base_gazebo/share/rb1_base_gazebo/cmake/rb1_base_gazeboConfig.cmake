...
if("TRUE" STREQUAL "TRUE")
  set(rb1_base_gazebo_SOURCE_PREFIX /home/avinaash/doozy_ws/src/rb1_base_sim/rb1_base_gazebo)
  set(rb1_base_gazebo_DEVEL_PREFIX /home/avinaash/doozy_ws/devel/.private/rb1_base_gazebo)
  ...
  set(rb1_base_gazebo_INSTALL_PREFIX /home/avinaash/doozy_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rb1_base_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/doozy_ws/src/rb1_base_sim/rb1_base_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/doozy_ws/devel/.private/rb1_base_gazebo/lib;/home/avinaash/doozy_ws/devel/lib;/opt/ros/noetic/lib)
