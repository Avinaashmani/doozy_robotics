...
if("TRUE" STREQUAL "TRUE")
  set(rb1_base_gazebo_SOURCE_PREFIX /home/avinaash/doozy_robotics/doozy_ws/src/rb1_base_sim/rb1_base_gazebo)
  set(rb1_base_gazebo_DEVEL_PREFIX /home/avinaash/doozy_robotics/doozy_ws/devel/.private/rb1_base_gazebo)
  ...
  set(rb1_base_gazebo_INSTALL_PREFIX /home/avinaash/doozy_robotics/doozy_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/rb1_base_gazebo " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Roberto Guzmán <rguzman@robotnik.es>, Roman Navarro Garcia <rnavarro@robotnik.es>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rb1_base_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/doozy_robotics/doozy_ws/src/rb1_base_sim/rb1_base_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/doozy_robotics/doozy_ws/devel/.private/rb1_base_gazebo/lib;/home/avinaash/doozy_robotics/doozy_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rb1_base_gazebo_EXPORTED_TARGETS ${${rb1_base_gazebo_dep}_EXPORTED_TARGETS})
endforeach()
