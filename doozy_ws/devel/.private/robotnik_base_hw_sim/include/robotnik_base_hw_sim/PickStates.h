...
struct PickStates_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::robotnik_base_hw_sim::PickState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::robotnik_base_hw_sim::PickState_<ContainerAllocator> >> _picks_type;
  _picks_type picks;
