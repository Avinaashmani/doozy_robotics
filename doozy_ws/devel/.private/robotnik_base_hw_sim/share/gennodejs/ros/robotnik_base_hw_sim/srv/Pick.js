...
class PickRequest {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.object_model);
    length += _getByteLength(object.object_link);
    length += _getByteLength(object.robot_model);
    length += _getByteLength(object.robot_link);
    return length + 72;
  }
