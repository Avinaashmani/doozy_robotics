...
"""autogenerated by genpy from dolly_action_msgs/amrDockActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class amrDockActionFeedback(genpy.Message):
  _md5sum = "5bd8faead91743645c1b7bc4684d9d5e"
  _type = "dolly_action_msgs/amrDockActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dolly_action_msgs/amrDockFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(amrDockActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dolly_action_msgs.msg.amrDockFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dolly_action_msgs.msg.amrDockFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.dist_to_pallet
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.dist_to_pallet,) = _get_struct_d().unpack(str[start:end])
      return self
