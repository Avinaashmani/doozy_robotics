...
let amrDockGoal = require('./amrDockGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class amrDockActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = amrDockGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new amrDockActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = amrDockGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new amrDockGoal()
    }
...
module.exports = amrDockActionGoal;
